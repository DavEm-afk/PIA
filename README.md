...
Ademas se busca agregar como tercer tarea la obtencion de metadata de archivos y de conexiones a redes, siendo un añadido al analisis general que se busca generar con el protecto, tanto de procesos como de archivos.
